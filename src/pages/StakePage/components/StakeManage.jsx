...
import { ReactComponent as UserIcon } from "../../../assets/stake/user-svgrepo-com.svg";
...
const StakeManage = ({ selectedList }) => {
  ...
  const addressData = [
    { id: 1, img: "", header: "Account Address", data: selectedList.identity },
    { id: 2, img: "", header: "Validator Address", data: selectedList.tokens },
    {
      id: 3,
      img: "",
      header: "Consensus Public Address",
      data: selectedList.delegation,
    },
    {
      id: 4,
    ...
    { id: 5, img: "", header: "Signer Address", data: selectedList.contact },
  ];
        ...
        <div className="container">
          <div className="stake-content">
            ...
            <div className="stake-manage-cards">
              ...
              <div className="bottom-stake-cards">
                <div className="reward-card">
                  ...
                  >
                    <h3>{`Stake with ${selectedList.name} to earn rewards`}</h3>
                  </div>
                </div>
